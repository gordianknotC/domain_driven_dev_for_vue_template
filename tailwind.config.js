...
const cColors = require("./src/colors");
...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      textColor: theme => ({
        DEFAULT: cColors.label.DEFAULT,
        dark: cColors.label.dark,
        light: cColors.label.light,
        link: cColors.primary.DEFAULT,
        "link-sec": cColors.secondary.DEFAULT,
        "link-dark": cColors.primary.dark,
      }),
      zIndex: {
        75: 75,
        100: 100
      ...
      boxShadow: {
        DEFAULT: "1.93535px 4.96164px 8.4491px rgba(209, 217, 230, 0.8), -3.29px -4.24667px 8.19689px rgba(255, 255, 255, 0.75)"
      },
  ...
  plugins: [
    function ({ addComponents, theme }) {
      addComponents({
        ...
        ".input-inner-shadow": {
          boxShadow: "inset 4.79419px 3.83535px 5.43341px rgba(209, 217, 230, 0.34),\n" +
