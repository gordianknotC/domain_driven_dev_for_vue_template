...
class RemoteClientServiceImpl extends RemoteClientService{
  ...
  static singleton(
    ...
    if (this._instance != undefined) {
      assert(()=>requestPlugins != undefined, AssertMessages.notUndefined("requestParam"));
  ...
  get canResetAsIdle(): boolean{
    return this.stage == EClientStage.error || this.stage == EClientStage.success;
  }

  private async fetch(method: "get" | "post" | "del" | "put", url: string, params: Record<string, any>): Promise<AxiosResponse<any>>{
  ...
  async get(url: string, payload: Record<string, any>): Promise<AxiosResponse<any, any>> {
    try{
  ...
  async post(url: string, payload: Record<string, any>): Promise<AxiosResponse<any, any>> {
    try{
  ...
  async put(url: string, payload: Record<string, any>): Promise<AxiosResponse<any, any>> {
    try{
  ...
  async dl(url: string, payload: Record<string, any>): Promise<AxiosResponse<any, any>> {
    try{
      const result = await this.fetch("post", url, payload)
      return result.data;
    }catch(e){
  ...
  async del(url: string, payload: Record<string, any>): Promise<AxiosResponse<any, any>> {
    try{
